...
│   │   ├── limitranges_get.go     # limitranges_get
...
| `limitranges_get` (R)      | `LimitRangeResult`                   | per-`limits[]` min/max/default/maxLimitRequestRatio                                                                                    |
